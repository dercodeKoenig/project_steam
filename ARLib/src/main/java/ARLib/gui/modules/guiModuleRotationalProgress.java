...
public class guiModuleRotationalProgress extends GuiModuleBase {
    ...
    public ResourceLocation bg = ResourceLocation.fromNamespaceAndPath("arlib", "textures/gui/simple_scale_round.png");
    public ResourceLocation arrow = ResourceLocation.fromNamespaceAndPath("arlib", "textures/gui/red_arrow.png");
