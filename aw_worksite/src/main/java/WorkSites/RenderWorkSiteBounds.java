...
public class RenderWorkSiteBounds implements BlockEntityRenderer<EntityWorkSiteBase> {
    ...
    public RenderWorkSiteBounds(BlockEntityRendererProvider.Context c) {
        super();
    }

    @Override
    public AABB getRenderBoundingBox(EntityWorkSiteBase tile) {
        return new AABB(tile.getBlockPos()).inflate(tile.maxSize);
    }

    @Override
    public void render(EntityWorkSiteBase tile, float v, PoseStack stack, MultiBufferSource multiBufferSource, int i, int i1) {
