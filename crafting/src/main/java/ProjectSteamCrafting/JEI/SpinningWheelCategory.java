...
public  class SpinningWheelCategory implements IRecipeCategory<SpinningWheelConfig.SpinningWheelRecipe> {
    ...
    public SpinningWheelCategory() {
    }

    public static final RecipeType<SpinningWheelConfig.SpinningWheelRecipe> recipeType = new RecipeType<>(
            ResourceLocation.fromNamespaceAndPath("projectsteam_crafting", "spinning_wheel_recipe"),
            SpinningWheelConfig.SpinningWheelRecipe.class
    );
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, SpinningWheelConfig.SpinningWheelRecipe recipe, IFocusGroup focuses) {
    ...
    @Override
    public void draw(SpinningWheelConfig.SpinningWheelRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        guiGraphics.blit(
    ...
    @Override
    public boolean isHandled(SpinningWheelConfig.SpinningWheelRecipe recipe) {
